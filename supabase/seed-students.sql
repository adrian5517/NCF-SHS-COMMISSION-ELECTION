-- ============================================================
-- NCF-Gradeschool-Voting — mockup STUDENTS
...
insert into public.students (lrn, full_name, grade_level, section, status)
select v.lrn, v.full_name, v.grade_level, v.section, v.status
from (values
  -- ---------- Grade 1 ----------
...
) as v(lrn, full_name, grade_level, section, status)
where not exists (
